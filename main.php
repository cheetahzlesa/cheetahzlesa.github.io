  ...
  <h2>Kontrola odovzdaní (Admin)</h2>
    ...
    <?php
      ...
      if (!$rows) {
        ...
        foreach ($rows as $r) {
          $ansShort = $r['answer_text'] !== null ? mb_strimwidth($r['answer_text'], 0, 120, '…', 'UTF-8') : '';
          ...
          echo '<td style="max-width:420px;">'.htmlspecialchars($ansShort, ENT_QUOTES).'</td>';
          echo '<td>'.$fileHtml.'</td>';
